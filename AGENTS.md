...
App: **zip** at https://zip.vibekit.bot (also https://solana.zip)
Repo: 609NFT/zip | Port: 4028 | Container: vk-zip
...
- Never mention localhost. App URL: **https://zip.vibekit.bot**.
- Verify before claiming success: `curl -s -o /dev/null -w "%{http_code}" https://zip.vibekit.bot/`.
...
- Must listen on **0.0.0.0:4028**, never localhost.
